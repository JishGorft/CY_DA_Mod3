...
SELECT
    ...
    total_spend /
    SUM(total_spend) OVER () AS percent_of_total
FROM customer_spend
ORDER BY total_spend DESC;
...
-- i wish to restate my opposition to exercises that return to data. on the basis that it f_cks with my head.
